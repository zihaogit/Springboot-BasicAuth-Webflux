...
public enum AuthResponseCode {
    ...
    AUTH_000104_FEDERATED_ID_REGISTERED("AUTH-000104", "auth.error.000104", HttpStatus.BAD_REQUEST),
    ...
    AUTH_000201_INVALID_OTP("AUTH-000201", "auth.error.000201", HttpStatus.BAD_REQUEST),
    AUTH_000202_EXPIRED_OTP("AUTH-000202", "auth.error.000202", HttpStatus.BAD_REQUEST),
    AUTH_000203_INVALID_OTP_REQUEST("AUTH-000203", "auth.error.000203", HttpStatus.BAD_REQUEST),
