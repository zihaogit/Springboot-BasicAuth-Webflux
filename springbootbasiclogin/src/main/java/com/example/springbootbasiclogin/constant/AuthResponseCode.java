...
public enum AuthResponseCode {
    ...
    AUTH_000107_EMAIL_REGISTERED_BEFORE("AUTH-000107", "auth.error.000107", HttpStatus.BAD_REQUEST),
    ...
    AUTH_000111_FAILED_ACCESS_MEMBER_CLASS("AUTH-000111", "auth.error.000111", HttpStatus.INTERNAL_SERVER_ERROR),
    AUTH_000112_SOCIAL_AUTH_FAILED("AUTH-000112", "auth.error.000112", HttpStatus.BAD_REQUEST),
    AUTH_000113_IDP_COMMUNICATION_ERROR("AUTH-000113", "auth.error.000113", HttpStatus.BAD_GATEWAY),
    AUTH_000115_INVALID_REFRESH_TOKEN("AUTH-000115", "auth.error.000115", HttpStatus.BAD_REQUEST),
